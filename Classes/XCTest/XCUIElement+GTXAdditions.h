...
@interface XCUIElement (GTXAdditions)

- (UIAccessibilityElement *)gtxtest_accessibilityElementWithContainer:(id)container;

/**
 * Converts this element into its proto representation. Does not set parent child relationships.
 * @return A UIElement proto representing this element.
 */
- (UIElementProto)gtx_toProto;

/**
 * Converts this element and all of its descendants into their proto representations. Sets the
 * parent child relationships of each element.
 * @return The accessibility hierarchy defined by this element.
 */
