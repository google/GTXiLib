...
#ifndef THIRD_PARTY_OBJECTIVE_C_GTXILIB_TESTS_COMMON_OOPTESTLIB_CPP_GTXTEST_ALWAYS_FAILING_CHECK_H_
#define THIRD_PARTY_OBJECTIVE_C_GTXILIB_TESTS_COMMON_OOPTESTLIB_CPP_GTXTEST_ALWAYS_FAILING_CHECK_H_
...
class GTXTestAlwaysFailingCheck : public gtx::Check {
 public:
  static const int RESULT_ID_FAILURE = 1;
...
#endif  // THIRD_PARTY_OBJECTIVE_C_GTXILIB_TESTS_COMMON_OOPTESTLIB_CPP_GTXTEST_ALWAYS_FAILING_CHECK_H_
